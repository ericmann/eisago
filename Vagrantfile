...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "ericmann/eisago"

  config.vm.hostname = "eisago"
  ...
  #
  config.vm.network :private_network, id: "eisago_primary", ip: "192.168.50.4"
  ...
  #
  config.vm.network "forwarded_port", guest: 27017, host: 27817
  config.vm.network "forwarded_port", guest: 28017, host: 28817
end